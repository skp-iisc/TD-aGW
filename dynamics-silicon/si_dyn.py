...
ax1.set_xlabel(r"$\omega$ (eV)", fontsize=16)
ax1.set_ylabel(r"$\epsilon_1(\omega)$", fontsize=16)
...
ax2.set_xlabel(r"$\omega$ (eV)", fontsize=16)
ax2.set_ylabel(r"$\epsilon_2(\omega)$", fontsize=16)
